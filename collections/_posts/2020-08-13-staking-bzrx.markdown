...
iBZRX is the [iToken](https://bzx.network/itokens) equivalent of BZRX that you recieve as a placeholder when lending BZRX to the protocol. This is also able to be staked and yields the same rewards as BZRX + the additional interest earned from lending.
